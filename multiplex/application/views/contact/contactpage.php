    ...
    <section class="contact-section padding-top">
        <div class="contact-container">
            <div class="bg-thumb bg_img" data-background="<?php echo base_url(); ?>assets/images/contact/contact.jpg"></div>
            <div class="container">
                            ...
                            <div class="info-area">
                                <div class="info-item">
                                    <div class="info-thumb">
                                        <img src="<?php echo base_url(); ?>assets/images/contact/contact01.png" alt="contact">
                                    </div>
                                ...
                                <div class="info-item">
                                    <div class="info-thumb">
                                        <img src="<?php echo base_url(); ?>assets/images/contact/contact02.png" alt="contact">
                                    </div>
                                    <div class="info-content">
                                        <h6 class="title">Email</h6>
                                        <a href="Mailto:info@gmail.com"><span class="__cf_email__" data-cfemail="5930373f36191b36353c2d36">[email&#160;protected]</span> .com</a>
                                    </div>
                                </div>
                            </div>
                        </div>
