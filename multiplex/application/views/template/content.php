                        ...
                        <div class="owl-carousel owl-theme tab-slider">
                            ...
                            <div class="item">
                                <div class="event-grid">
                                    <div class="movie-thumb c-thumb" style="max-height: 300px;">
                                        <a href="#0">
                                            <img src="<?php echo base_url(); ?>/multiplexsystem/images/<?php echo $row->event_images ?>" alt="event">
                                        </a>
                                    ...
                                    <div class="movie-content bg-one">
                                        <h5 class="title m-0">
                                            <a href="#0" title="<?php echo $row->event_title; ?>"><?php echo substr($row->event_title, 0, 15); ?>...</a>
                                        </h5>
                        ...
                        <div class="owl-carousel owl-theme tab-slider">
                            ...
                            <div class="item">
                                <div class="sports-grid">
                                    <div class="movie-thumb c-thumb">
                                        <a href="#0">
                                            <img src="<?php echo base_url(); ?>/multiplexsystem/images/<?php echo $row->sports_images ?>" alt="sports">
                                        </a>
                                        <div class="event-date">
                                            <h6 class="date-title">28</h6>
                                            <span>Dec</span>
                                    ...
                                    <div class="movie-content bg-one">
                                        <h5 class="title m-0">
                                            <a href="#0"><?php echo $row->sports_title ?></a>
                                        </h5>
                                        <div class="movie-rating-percent">
                                            <span>327 Montague Street</span>
                                        </div>
