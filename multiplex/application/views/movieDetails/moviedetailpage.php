...
<section class="details-banner bg_img" data-background="<?php echo base_url(); ?>/multiplexsystem/images/<?php echo $row->movie_poster ?>">
        <div class="container">
            <div class="details-banner-wrapper">
                
                <div class="details-banner-thumb">
                    <img src="<?php echo base_url(); ?>/multiplexsystem/images/<?php echo $row->movie_images ?>" alt="movie">
                    <a href="<?php echo $row->movie_trailer; ?>" class="video-popup">
                ...
                <div class="details-banner-content offset-lg-3">
                    ...
                    <div class="tags">
                       <span><?php echo $row->movie_language; ?></span>
                    </div>
                   
                    <!-- getching movie category name ex:-action or thriller or drama... -->
                    <?php
                        $this->db->where('category_id', $row->category_id);
                        $cat_name = $this->db->get('moviecategory')->row();
                    ?>
                    <span <?php echo $cat_name->category_id ?>">
                    ...
                    <div class="social-and-duration">
                        <div class="duration-area">
                            ...
                            <div class="item">
                                ...
                                <span><?php echo $row->movie_duration ?></span>
                            </div>
                        </div>
                ...
                <div class="left-side">
                    <div class="item">
                        <div class="item-header">
                            <div class="thumb">
                                <img src="<?php echo base_url(); ?>assets/images/movie/tomato2.png" alt="movie">
                            </div>
                    ...
                    <div class="item">
                        <div class="item-header">
                            <h5 class="title"><?php echo $row->movie_rating ?></h5>
                            <div class="rated">
                ...
                <div class="col-lg-9 mb-50">
                    <div class="movie-details">
                        ...
                        <div class="details-photos owl-carousel">
                            <div class="thumb">
                                <a href="<?php echo base_url(); ?>assets/images/movie/movie-details01.jpg" class="img-pop">
                                    <img src="<?php echo base_url(); ?>assets/images/movie/movie-details01.jpg" alt="movie">
                                </a>
                            </div>
                            <div class="thumb">
                                <a href="<?php echo base_url(); ?>assets/images/movie/movie-details02.jpg" class="img-pop">
                                    <img src="<?php echo base_url(); ?>assets/images/movie/movie-details02.jpg" alt="movie">
                                </a>
                            </div>
                            <div class="thumb">
                                <a href="<?php echo base_url(); ?>assets/images/movie/movie-details03.jpg" class="img-pop">
                                    <img src="<?php echo base_url(); ?>assets/images/movie/movie-details03.jpg" alt="movie">
                                </a>
                            </div>
                            <div class="thumb">
                                <a href="<?php echo base_url(); ?>assets/images/movie/movie-details01.jpg" class="img-pop">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="casting-slider-two owl-carousel">
                                            <div class="cast-item">
                                                <div class="cast-thumb">
                                                    <a href="#0">
                                                        <img src="<?php echo base_url(); ?>assets/images/cast/cast05.jpg" alt="cast">
                                                    </a>
                                                </div>
                                                <div class="cast-content">
                                            ...
                                            <div class="cast-item">
                                                <div class="cast-thumb">
                                                    <a href="#0">
                                                        <img src="<?php echo base_url(); ?>assets/images/cast/cast06.jpg" alt="cast">
                                                    </a>
                                                </div>
                                                <div class="cast-content">
                                            ...
                                            <div class="cast-item">
                                                <div class="cast-thumb">
                                                    <a href="#0">
                                                        <img src="<?php echo base_url(); ?>assets/images/cast/cast07.jpg" alt="cast">
                                                    </a>
                                                </div>
                                                <div class="cast-content">
                                            ...
                                            <div class="cast-item">
                                                <div class="cast-thumb">
                                                    <a href="#0">
                                                        <img src="<?php echo base_url(); ?>assets/images/cast/cast08.jpg" alt="cast">
                                                    </a>
                                                </div>
                                                <div class="cast-content">
