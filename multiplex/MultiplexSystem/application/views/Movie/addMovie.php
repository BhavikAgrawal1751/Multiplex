		...
		<div class="row">
			<div class="col-md-12">
				<section class="boxs">
					...
					<div class="boxs-body">
						<form class="form-horizontal" enctype="multipart/form-data" name="form4" action="<?php echo site_url(); ?>/MovieController/cinsert/" method="post" role="form" id="form4" data-parsley-validate>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									...
									<span class="btn btn-raised  fileinput-button">
										...
										<span>Add file</span>
										<input type="file" name="moPost" multiple>
									</span>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<!-- <input type="file" class="form-control" name="moImg" placeholder="Movie Images" data-parsley-trigger="change" required> -->
									<span class="btn btn-raised  fileinput-button">
										<i class="fa fa-upload" aria-hidden="true"></i>
										<span>Add file</span>
										<input type="file" name="moImg" multiple>
									</span>
								</div>
							</div>
