		...
		<div class="row">
			<div class="col-md-12">
				<section class="boxs">
					...
					<div class="boxs-body">
						<form class="form-horizontal" enctype="multipart/form-data" name="form4" action="<?php echo site_url(); ?>/MovieController/cupdate/<?php echo $editData->movie_id ?>" method="post" role="form" id="form4" data-parsley-validate>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									...
									<span class="btn btn-raised  fileinput-button">
										...
										<span>Add file</span>
										<input type="file" name="moPost" value="<?php echo $editData->movie_poster ?>" multiple>
									</span>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<!-- <input type="file" class="form-control" name="moImg" value="<?php echo $editData->movie_images ?>" data-parsley-trigger="change"> -->
									<span class="btn btn-raised  fileinput-button">
										<i class="fa fa-upload" aria-hidden="true"></i>
										<span>Add file</span>
										<input type="file" name="moImg" value="<?php echo $editData->movie_images ?>" multiple>
									</span>
								</div>
							</div>
