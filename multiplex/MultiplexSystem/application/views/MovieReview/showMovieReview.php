								...
								<table id="searchTextResults" data-filter="#filter" data-page-size="5" class="footable table table-custom">
									...
									<?php $count=1; foreach($data as $row) { ?>	
										<tr>
											...
											<td style="padding-top:30px;"><?php echo $row->review_detail;?></td>
											<td style="padding-top:10px;"><a href="<?php echo site_url(); ?>/MovieReviewController/delete/<?php echo $row->review_id ?>" class="btn btn-raised btn-danger" id="de"><i class='fa fa-trash'></i> Delete</a></td>
										</tr>
									<?php $count++; } ?>
											</tbody>
