          ...
          <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 text-center">
            <div class="card card-signup">
              <form class="form" method="post" action="<?php echo site_url(); ?>/LoginController/chklogin/">
                ...
                <h3 class="mt-0">Multiplex System</h3>
                <p class="help-block">Admin</p>
                <p style="color:red;" id="err"><?php echo $err; ?></p>
                <div class="content">
                  <div class="form-group">
                    <input type="email" name="txtemail" onkeyup="geterr()" class="form-control underline-input" placeholder="Enter Your Email">
                  </div>
                  <div class="form-group">
                    <input type="password" name="txtpwd" placeholder="Password..." class="form-control underline-input">
                  </div>
