		...
		<div class="row">
			<div class="col-md-12">
				<section class="boxs">
					...
					<div class="boxs-body">
						<form class="form-horizontal" enctype="multipart/form-data" name="form4" action="<?php echo site_url(); ?>/AdminController/cinsert/" method="post" role="form" id="form4" data-parsley-validate>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<span class="btn btn-raised  fileinput-button">
										...
										<span>Add file</span>
										<input type="file" name="adminImg" multiple>
									</span>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="number" onclick="abc()" class="form-control" name="adminMob" placeholder="Admin Mobile" data-parsley-trigger="change" required>
								</div>
							</div>
					</div>
