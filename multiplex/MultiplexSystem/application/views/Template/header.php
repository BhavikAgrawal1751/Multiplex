    ...
    <div id="wrap" class="animsition">
        ...
        <div id="header">
            <header class="clearfix">
                <!-- Branding -->
                <div class="branding">
                    <a class="brand" href="<?php echo site_url(); ?>/LoginController/adminpanel/">
                        <!-- <img src="<?php echo base_url();?>assets/images/f.png" width="45" height="45"> -->
                        <span>Multiplex System</span> 
                    </a>
                ...
                <ul class="nav-right pull-right list-inline">
                    ...
                    <li class="dropdown nav-profile">
                        <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<?php echo base_url(); ?>/images/<?php echo $this->session->userdata('adminimage') ?>" alt="" class="0 size-30x30"> </a>
                        <ul class="dropdown-menu pull-right" role="menu">
                            ...
                            <li>
                                <a href="<?php echo site_url(); ?>/ProfileController/" role="button" tabindex="0">
                            ...
                            <li>
                                <a href="<?php echo site_url(); ?>/LoginController/logout/" role="button" tabindex="0">
