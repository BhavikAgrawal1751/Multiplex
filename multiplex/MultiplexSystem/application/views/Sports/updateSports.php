		...
		<div class="row">
			<div class="col-md-12">
				<section class="boxs">
					...
					<div class="boxs-body">
						<form class="form-horizontal" enctype="multipart/form-data" name="form4" action="<?php echo site_url(); ?>/SportsController/cupdate/<?php echo $editData->sports_id ?>" method="post" role="form" id="form4" data-parsley-validate>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<!-- <input type="file" class="form-control" name="sprImages" value="<?php echo $editData->sports_images ?>" data-parsley-trigger="change"> -->
									<span class="btn btn-raised  fileinput-button">
										<i class="fa fa-upload" aria-hidden="true"></i>
										<span>Add file</span>
										<input type="file" name="sprImages" value="<?php echo $editData->sports_images ?>" multiple>
									</span>
								</div>
							</div>
