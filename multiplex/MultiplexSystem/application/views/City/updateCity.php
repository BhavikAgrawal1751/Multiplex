				...
				<section class="boxs">
					<div class="boxs-header">
						<h3 class="custom-font hb-blush">
							<strong>Update</strong> City
						</h3>
					</div>
					<div class="boxs-body">
						<form class="form-horizontal" name="form4" action="<?php echo site_url(); ?>/CityController/cupdate/<?php echo $editData->city_id ?>" method="post" role="form" id="form4" data-parsley-validate>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" name="cityName" value="<?php echo $editData->city_name ?>" data-parsley-trigger="change" required>
								</div>
							</div>
					</div>
