		...
		<div class="row">
			<div class="col-md-12">
				<section class="boxs">
					...
					<div class="boxs-body">
						<form class="form-horizontal" enctype="multipart/form-data" name="form4" action="<?php echo site_url(); ?>/MovieImgController/cupdate/<?php echo $editData->movieimg_id ?>" method="post" role="form" id="form4" data-parsley-validate>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">Movie Image</label>
								<div class="col-sm-9">
									<span class="btn btn-raised  fileinput-button">
										<i class="fa fa-upload" aria-hidden="true"></i>
										<span>Add file</span>
										<input type="file" name="moImg" multiple value="<?php echo $editData->movieimg ?>">
									</span>
								</div>
							</div>
					</div>
					<div class="boxs-footer text-right bg-tr-black lter dvd dvd-top">
						<button type="submit" class="btn btn-raised btn-success" id="form4Submit" style="border-radius: 50px !important;font-weight: 500;">Update</button>
						</form>
					</div>
				</section>
			</div>
