		...
		<div class="row">
			<div class="col-md-12">
				<section class="boxs">
					...
					<div class="boxs-body">
						<form class="form-horizontal" enctype="multipart/form-data" name="form4" action="<?php echo site_url(); ?>/EventController/cinsert/" method="post" role="form" id="form4" data-parsley-validate>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<!-- <input type="file" class="form-control" name="eventImage" placeholder="Event Image" data-parsley-trigger="change" required> -->
									<span class="btn btn-raised  fileinput-button">
										<i class="fa fa-upload" aria-hidden="true"></i>
										<span>Add file</span>
										<input type="file" name="eventImage" multiple>
									</span>
								</div>
							</div>
